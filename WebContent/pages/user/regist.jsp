...
$(function(){
	...
	//给name为username的input 绑定change事件
	...
	$("#code_img").click(function(){
		...
		this.src="code.jsp?t="+Math.random();
	});
						...
						<div class="login_box">
							...
							<div class="form">
								<form action="client/UserServlet?method=regist" method="post">
									...
									<img id="code_img" alt="" src="code.jsp" style="float: right; margin-right: 40px;width: 80px; height: 40px;">									
									<br />
									<br />
