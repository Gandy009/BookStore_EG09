		...
		<c:choose>
			...
			<c:otherwise>
				...
				<div class="cart_info">
					...
					</span> <span class="cart_span"><a id="clear_btn" href="client/CartServlet?method=clear">清空购物车</a></span>
